...
class Protocol::HTTP1::Connection
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#223
  def close(error = T.unsafe(nil)); end
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#717
  def close!(error = T.unsafe(nil)); end
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#709
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#852
  ...
  # @return [Boolean]
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#435
  def interim_status?(status); end

  # Force a transition to the open state.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#240
  def open!; end
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#340
  def read(length); end
  ...
  # @return [Boolean]
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#349
  def read_line?; end

  # Read the body, assuming that we read until the connection is closed.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#801
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#921
  def read_request_body(method, headers); end

  # Read a request line from the connection.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#371
  def read_request_line; end

  # Read a response from the connection.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#446
  ...
  # - Otherwise, the body is read according to {read_body}.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#873
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#822
  ...
  # Invokes {read_remainder_body}.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#831
  def read_upgrade_body; end

  # Read some data from the connection.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#333
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#772
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#736
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#681
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#581
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#310
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#275
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#554
  ...
  # The connection will not be persistent after this method is called.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#522
...
#
# source://protocol-http1//lib/protocol/http1/connection.rb#841
...
#
# source://protocol-http1//lib/protocol/http1/connection.rb#838
...
#
# source://protocol-http1//lib/protocol/http1/connection.rb#844
