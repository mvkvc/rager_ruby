...
class Protocol::HTTP::AcceptEncoding < ::Protocol::HTTP::Middleware
  ...
  #
  # source://protocol-http//lib/protocol/http/accept_encoding.rb#44
...
class Protocol::HTTP::Body::Buffered < ::Protocol::HTTP::Body::Readable
  ...
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#50
  ...
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#77
  def close(error = T.unsafe(nil)); end

  # Close the body for writing. This is a no-op.
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#131
  def close_write(error); end

  # Discard the body. Invokes {#close}.
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#120
  def discard; end
  ...
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#70
  def finish; end

  # Inspect the buffered body.
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#154
  def inspect; end

  # The length of the body. Will compute and cache the length of the body, if it was not provided.
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#91
  def length; end

  # Read the next chunk from the buffered body.
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#109
  def read; end
  ...
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#143
  def rewind; end
  ...
  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#138
  def rewindable?; end

  # Write a chunk to the buffered body.
  #
  # source://protocol-http//lib/protocol/http/body/buffered.rb#126
  def write(chunk); end
...
class Protocol::HTTP::Body::Deflate < ::Protocol::HTTP::Body::ZStream
  ...
  #
  # source://protocol-http//lib/protocol/http/body/deflate.rb#101
  def read; end

  class << self
    # Create a new body which compresses the given body using the GZIP algorithm by default.
    #
    # source://protocol-http//lib/protocol/http/body/deflate.rb#94
...
class Protocol::HTTP::Body::Head < ::Protocol::HTTP::Body::Readable
  ...
  #
  # source://protocol-http//lib/protocol/http/body/head.rb#25
  def initialize(length); end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/body/head.rb#30
  def empty?; end

  # source://protocol-http//lib/protocol/http/body/head.rb#40
  def length; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/body/head.rb#35
  def ready?; end

  class << self
    # Create a head body for the given body, capturing it's length and then closing it.
    #
    # source://protocol-http//lib/protocol/http/body/head.rb#14
    def for(body); end
  end
end
...
class Protocol::HTTP::Body::Stream
  ...
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#370
  def close(error = T.unsafe(nil)); end
  ...
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#344
  ...
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#359
  def close_write(error = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#380
  def closed?; end
  ...
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#336
  def flush; end
  ...
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#323
  def puts(*arguments, separator: T.unsafe(nil)); end

  # Write data to the underlying stream.
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#292
  ...
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#308
  ...
  #
  # source://protocol-http//lib/protocol/http/body/stream.rb#395
  def read_next; end
end
...
#
# source://protocol-http//lib/protocol/http/headers.rb#31
class Protocol::HTTP::Headers
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#371
  def ==(other); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#230
  def []=(key, value); end

  # Add the specified header key value pair.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#198
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#351
  def as_json; end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#161
  def each(&block); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#107
  def fields; end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#92
  def flatten!; end
  ...
  # Inspect the headers.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#364
  def inspect; end
  ...
  # source://protocol-http//lib/protocol/http/headers.rb#173
  def keys; end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#206
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#130
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#123
  def trailer!(&block); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#77
...
#
# source://protocol-http//lib/protocol/http/headers.rb#383
class Protocol::HTTP::Headers::Merged
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#389
  def initialize(*all); end

  # Add a new set of headers to the merged list.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#411
  def <<(headers); end

  # Clear the references to all headers.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#404
  def clear; end

  # Enumerate all headers in the merged list.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#422
  def each(&block); end

  # source://protocol-http//lib/protocol/http/headers.rb#394
  def fields; end

  # source://protocol-http//lib/protocol/http/headers.rb#399
  def flatten; end
end
...
#
# source://protocol-http//lib/protocol/http/headers.rb#239
Protocol::HTTP::Headers::POLICY = T.let(T.unsafe(nil), Hash)

# source://protocol-http//lib/protocol/http/headers.rb#32
