...
# source://async-http//lib/async/http/version.rb#6
module Async; end

# source://async-http//lib/async/http/version.rb#7
...
# source://async-http//lib/async/http/internet.rb#16
class Async::HTTP::Internet
  # @return [Internet] a new instance of Internet
  #
  # source://async-http//lib/async/http/internet.rb#17
  ...
  # source://async-http//lib/async/http/internet.rb#26
  def client_for(endpoint); end

  # A cache of clients.
  #
  # source://async-http//lib/async/http/internet.rb#24
  def clients; end

  # source://async-http//lib/async/http/internet.rb#62
  def close; end

  # source://async-http//lib/async/http/internet.rb#71
  ...
  # source://async-http//lib/async/http/internet.rb#84
  def host_key(endpoint); end

  # source://async-http//lib/async/http/internet.rb#78
...
class Async::HTTP::Server < ::Protocol::HTTP::Middleware
  ...
  # source://async-http//lib/async/http/server.rb#65
  def run; end
...
# source://async-http//lib/async/http/version.rb#8
