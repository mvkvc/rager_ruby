...
class RuboCop::Cop::Lint::AssignmentInCondition < ::RuboCop::Cop::Base
  ...
  # source://rubocop/1.75.4/lib/rubocop/cop/lint/assignment_in_condition.rb#55
  def on_if(node); end
  ...
  # source://rubocop/1.75.4/lib/rubocop/cop/lint/assignment_in_condition.rb#80
  def allowed_construct?(asgn_node); end

  # source://rubocop/1.75.4/lib/rubocop/cop/lint/assignment_in_condition.rb#84
  def conditional_assignment?(asgn_node); end

  # source://rubocop/1.75.4/lib/rubocop/cop/lint/assignment_in_condition.rb#88
  def skip_children?(asgn_node); end

  # source://rubocop/1.75.4/lib/rubocop/cop/lint/assignment_in_condition.rb#94
  def traverse_node(node, &block); end
end

# source://standard//lib/standard/rubocop/ext.rb#9
class RuboCop::DirectiveComment
  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#46
  def initialize(comment, cop_registry = T.unsafe(nil)); end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#115
  def all_cops?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#44
  def comment; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#120
  def cop_names; end
  ...
  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#131
  def department_names; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#145
  def directive_count; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#95
  def disabled?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#110
  def disabled_all?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#100
  def enabled?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#105
  def enabled_all?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#136
  def in_directive_department?(cop); end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#150
  def line_number; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#59
  def malformed?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#77
  def match?(cop_names); end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#90
  def match_captures; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#67
  def missing_cop_name?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#44
  def mode; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#141
  def overridden_by_department?(cop); end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#81
  def range; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#125
  def raw_cop_names; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#72
  def single_line?; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#54
  def start_with_marker?; end

  private

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#167
  def all_cop_names; end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#171
  def cop_names_for_department(department); end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#163
  def department?(name); end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#176
  def exclude_lint_department_cops(cops); end

  # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#156
  def parsed_cop_names; end

  class << self
    # source://rubocop/1.75.4/lib/rubocop/directive_comment.rb#40
